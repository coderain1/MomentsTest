...
class CommentListView : LinearLayout {
    ...
    var data: MutableList<CommentBean> = ArrayList()
        set(value) {
            field.clear()
    ...
    private fun setClickableSpan(position: Int, text: String?, user: UserBean?): SpannableString {
    ...
    interface OnItemClickListener {
        ...
        fun onItemUserClick(position: Int, user: UserBean?)
    }
}